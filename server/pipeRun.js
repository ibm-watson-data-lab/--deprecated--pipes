		...
		pipeDb.saveRun( pipe, this.runDoc,function( err, runDoc ){
			...
			async.map( tables, function( table, callback ){
				...
				finishStep1( err, statsArray, function( err ){
					...
					createDataWorksActivities( statsArray, function( err, dataWorksStats ){
